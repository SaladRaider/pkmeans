...
int main(int argc, char **argv) {
    ...
    desc.add_options ()
        ...
        ("buckets,b",       po::value<unsigned int> (), "number of buckets")
    ...
    const unsigned int numBuckets = vm["buckets"].as<unsigned int> ();
    ...
    PKMeans<unsigned int> pkmeans;
    pkmeans.run (numClusters, numBuckets, numThreads,
